...
const SmartStudioPage: React.FC = () => {
    ...
    const renderActiveTool = () => {
        ...
        switch (activeTool) {
            ...
            case 'web-search': return <WebSearchTool onBack={handleBack} />;
            case 'local-discovery': return <LocalDiscoveryTool onBack={handleBack} />;
            case 'text-to-speech': return <TextToSpeechTool onBack={handleBack} />;
            case 'study-plan': return <StudyPlanGeneratorTool onBack={handleBack} />;
            case 'code-reviewer': return <CodeReviewerTool onBack={handleBack} />;
            case 'document-summarizer': return <DocumentSummarizerTool onBack={handleBack} />;
            default: return null;
        }
    }
    ...
    return (
        <div className="h-full p-4 md:p-8 bg-gray-100 dark:bg-gray-900">
