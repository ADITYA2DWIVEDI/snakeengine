    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file && file.type.startsWith('video/')) {
            ...
            setMessages([{
                id: 'init-vid',
                role: 'model',
                text: "Video loaded! What would you like to know about it?",
            }]);
        ...
        <div className="h-full flex flex-col bg-slate-200/50 dark:bg-slate-800/50 rounded-2xl shadow-lg">
            {!videoFile ? (
                <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 max-w-md my-2">Ask for summaries, identify key moments, or transcribe content.</p>
