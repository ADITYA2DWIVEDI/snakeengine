...
const DocumentSummarizerTool: React.FC<ToolProps> = ({ onBack }) => {
    ...
    return (
        <div className="h-full flex flex-col p-4 md:p-8 bg-transparent overflow-y-auto">
            <div className="w-full max-w-4xl mx-auto flex-grow flex flex-col">
                ...
                <div className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    <label 
                        htmlFor="file-upload" 
